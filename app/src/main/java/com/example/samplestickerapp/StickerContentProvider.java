...
public class StickerContentProvider extends ContentProvider {
    ...
    private List<Sticker_packs> stickerPackList;
    ...
    public boolean onCreate() {
        ...
        for (Sticker_packs stickerPack : getStickerPackList()) {
    ...
    @NonNull
    private Cursor getStickerPackInfo(@NonNull Uri uri, @NonNull List<Sticker_packs> stickerPackList) {
