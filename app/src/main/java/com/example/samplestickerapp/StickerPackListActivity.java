...
public class StickerPackListActivity extends AddStickerPackActivity implements SearchView.OnQueryTextListener {
    ...
    private void showStickerPackList(List<Sticker_packs> stickerPackList) {
        allStickerPacksListAdapter = new StickerPackListAdapter(stickerPackList, onAddButtonClickedListener, OnContainerLayoutClickedListener, this);
    ...
    private final StickerPackListAdapter.OnContainerLayoutClickedListener OnContainerLayoutClickedListener = pack -> {
        admobObj.showIntrestrialAds(getApplicationContext(), new admobCloseEvent() {
            @Override
            public void setAdmobCloseEvent() {
