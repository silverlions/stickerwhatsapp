...
public class StickerPackLoader {
     ...
     */
    @NonNull
    public static ArrayList<Sticker_packs> fetchStickerPacks(Context context) throws IllegalStateException {
        ...
        final ArrayList<Sticker_packs> stickerPackList = fetchFromContentProvider(cursor);
    ...
    @NonNull
    private static List<Sticker> getStickersForPack(Context context, Sticker_packs stickerPack) {
    ...
    @NonNull
    private static ArrayList<Sticker_packs> fetchFromContentProvider(Cursor cursor) {
        ArrayList<Sticker_packs> stickerPackList = new ArrayList<>();
        cursor.moveToFirst();
        do {
            ...
            final Sticker_packs stickerPack = new Sticker_packs(identifier, name, publisher, trayImage, publisherEmail, publisherWebsite, privacyPolicyWebsite, licenseAgreementWebsite);
